...
public class RecycleBinController {
    ...
    public Result<Void> saveRecycleBin(@RequestBody RecycleBinSaveReqDTO recycleBinSaveReqDTO){
        actualRemoteService.saveRecycleBin(recycleBinSaveReqDTO);
    ...
    public Result<Page<ShortLinkPageRespDTO>> pageBinShortLink(ShortLinkRecycleBinPageReqDTO requestParam) {
    ...
    public Result<Void> recoverRecycleBin(@RequestBody RecycleBinRecoverReqDTO recycleBinRecoverReqDTO){
        actualRemoteService.recoverRecycleBin(recycleBinRecoverReqDTO);
        return Results.success();
    }
    ...
    public Result<Void> removeRecycleBin(@RequestBody RecycleBinRemoveReqDTO recycleBinRemoveReqDTO) {
        actualRemoteService.removeRecycleBin(recycleBinRemoveReqDTO);
        return Results.success();
    }
}
